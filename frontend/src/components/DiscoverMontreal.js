...
function DiscoverMontreal() {
  return (
    <div className="DiscoverMontreal" style={{ padding: '2rem', fontFamily: 'Inter, sans-serif', backgroundColor: '#F4F7F7', color: '#335058' }}>
      <header style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '3rem', fontWeight: '700', color: '#335058', padding:'1rem'}}>Discover Montreal</h1>
      ...
      <div style={{
        ...
        <div >
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center'}}>Old Montreal</p>
        </div>
        <div >
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center'  }}>Mount Royal Beaver Lake</p>
        </div>
        <div>
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center'}}>Smoked Meat Sandwich </p>
        </div>
        <div>
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center' }}>Poutine</p>
        </div>
        <div >
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center' }}>Basilique Notre-Dame</p>
        </div>
        <div >
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center' }}>Oratoire St-Joseph</p>
        </div>
        <div >
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center' }}>Montreal Canadiens</p>
        </div>
        <div >
          ...
          <p style={{ padding: '0.15rem', color: '#335058', fontWeight: '600', textAlign: 'center' }}>Montreal Museum of Fine Arts</p>
        </div>
      ...
      <footer style={{ textAlign: 'center', marginTop: '2rem', color: '#335058'}}>
        <p style={{ fontSize: '1rem', color: '#335058', fontWeight: '700'}}>Designed with care to highlight the charm of Montreal.</p>
      </footer>
    </div>
  );
}
